...
[];if(this._tiles.need_update)this.update_tileset(),this._tiles.need_update=!1;this.bgon&&this.render_background(b);this.winon&&this.render_window(b);this.objon&&this.render_sprites(b)}},update_tileset:function(){for(var b=this._tiles.to_update,c=this._tiles.data,a=this.vram,d=0;d<NUM_TILES;d++)if(b[d]){b[d]=!1;for(var l=d*16,g=0;g<8;g++,l+=2)for(var n=a[l],m=a[l+1],f=7;f>=0;f--)c[d][g][f]=(m&1)<<1|n&1,n>>=1,m>>=1}},render_background:function(b){var c=this.image.data,a=this.vrambanks[0],d=this.vrambanks[1],
l=this._pal.bg,g=this.mem.cgb,n=this._tiles.data,m=this.bgmap?7168:6144;m+=((this.ly+this.scy&255)>>3)*32;var f=(this.ly+this.scy)%8,h=this.scx%8,k=this.ly*640,e=0,o=this.tiledata==0?128:0;do{var i=(e+this.scx&255)>>3,j=a[m+i];this.tiledata==0&&(j=j+128&255);var q=0,p=0;g?(p=d[m+i],j=n[o+j+(p>>3&1)*NUM_TILES],l=this.cgb._bgp[p&7],q=p&128,j=j[p&64?7-f:f],p&=32):j=n[o+j][f];for(;h<8&&e<160;h++,e++,k+=4){var i=j[p?7-h:h],r=l[i];b[e]=q?4:i;c[k]=r[0];c[k+1]=r[1];c[k+2]=r[2];c[k+3]=r[3]}h=0}while(e<160)},
render_window:function(b){if(!(this.wy>=144||this.wx>=160)){var c=this.image.data,a=this.vrambanks,d=this._pal.bg,l=this.mem.cgb,g=this._tiles.data,n=this.winmap?7168:6144;n+=(this.ly+this.wy>>3)*32;var m=this.ly%8,f=this.wx%8,h=(this.ly+this.wy)*640,k=this.wx,e=this.tiledata==0?128:0;do{var o=k>>3,i=a[0][n+o];this.tiledata==0&&(i=i+128&255);var j=!1,q=!1;l?(q=a[1][n+o],i=g[e+i+(q>>3&1)*NUM_TILES],d=this.cgb._bgp[q&7],j=q&128,i=i[q&64?7-m:m],q&=32):i=g[e+i][m];for(;f<8&&k<160;f++,k++,h+=4){var o=
i[q?7-f:f],p=d[o];b[k]=j?4:i[o];c[h]=p[0];c[h+1]=p[1];c[h+2]=p[2];c[h+3]=p[3]}f=0}while(k<160)}},render_sprites:function(b){for(var c=this.image.data,a=this.oam,d=this.mem.cgb,l=this._tiles.data,g=this.ly,n=this.objsize?16:8,m=0;m<40;m++){var f=m*4,h=a[f]-16,k=a[f+1]-8,e=a[f+2],f=a[f+3];if(!(h>g||h+n<=g||k<=-8||k>=160)){n==16&&(e&=254,g-h>=8&&(e+=1,h+=8));var o=(160*g+k)*4,i;d?(e=l[(f>>3&1*NUM_TILES)+e],i=this.cgb._obp[f&3]):(i=f&16?this._pal.obp1:this._pal.obp0,e=l[e]);h=f&64?e[7-(g-h)]:e[g-h];for(e=
0;e<8;e++,o+=4)if(!(k+e<0||k+e>=160||b[e+k]>3)){var j=h[f&32?7-e:e];j!=0&&!(f&128&&b[k+e]!=0)&&(j=i[j],c[o]=j[0],c[o+1]=j[1],c[o+2]=j[2],c[o+3]=j[3])}}}},rb:function(b){switch(b&255){case 64:return this.lcdon<<7|this.winmap<<6|this.winon<<5|this.tiledata<<4|this.bgmap<<3|this.objsize<<2|this.objon<<1|this.bgon;case 65:return this.lycly<<6|this.mode2int<<5|this.mode1int<<4|this.mode0int<<3|(this.lycly==this.ly?4:0)|this.mode;case 66:return this.scy;case 67:return this.scx;case 68:return this.ly;case 69:return this.lyc;
