...
this.image=this.canvas.createImageData(160,144);this.white_canvas()},white_canvas:function(){for(var b=0;b<this.image.data.length;b++)this.image.data[b]=255;this.canvas.putImageData(this.image,0,0)},switch_mode0:function(){this.mode=JBA.GPU.Mode.HBLANK;this.render_line();this.mode0int&&(this.mem._if|=2)},switch_mode1:function(){this.mode=JBA.GPU.Mode.VBLANK;this.canvas!=null&&this.canvas.putImageData(this.image,0,0);this.mem._if|=1;this.mode1int&&(this.mem._if|=2)},switch_mode2:function(){this.mode=
JBA.GPU.Mode.RDOAM;this.mode2int&&(this.mem._if|=2)},switch_mode3:function(){this.mode=JBA.GPU.Mode.RDVRAM},step:function(b){b=this.clock+b;if(b>=456)b-=456,this.ly=(this.ly+1)%154,this.ly>=144&&this.mode!=JBA.GPU.Mode.VBLANK&&this.switch_mode1(),this.ly==this.lyc&&this.lycly&&(this.mem._if|=2);this.ly<144&&(b<=80?this.mode!=JBA.GPU.Mode.RDOAM&&this.switch_mode2():b<=252?this.mode!=JBA.GPU.Mode.RDVRAM&&this.switch_mode3():this.mode!=JBA.GPU.Mode.HBLANK&&this.switch_mode0());this.clock=b},render_line:function(){if(this.lcdon){var b=
[];if(this._tiles.need_update)this.update_tileset(),this._tiles.need_update=!1;this.bgon&&this.render_background(b);this.winon&&this.render_window(b);this.objon&&this.render_sprites(b)}},update_tileset:function(){for(var b=this._tiles.to_update,c=this._tiles.data,a=this.vram,d=0;d<NUM_TILES;d++)if(b[d]){b[d]=!1;for(var h=d*16,g=0;g<8;g++,h+=2)for(var n=a[h],m=a[h+1],f=7;f>=0;f--)c[d][g][f]=(m&1)<<1|n&1,n>>=1,m>>=1}},render_background:function(b){var c=this.image.data,a=this.vrambanks[0],d=this.vrambanks[1],
h=this._pal.bg,g=this.mem.cgb,n=this._tiles.data,m=this.bgmap?7168:6144;m+=((this.ly+this.scy&255)>>3)*32;var f=(this.ly+this.scy)%8,i=this.scx%8,l=this.ly*640,e=0,o=this.tiledata==0?128:0;do{var j=(e+this.scx&255)>>3,k=a[m+j];this.tiledata==0&&(k=k+128&255);var q=0,p=0;g?(p=d[m+j],k=n[o+k+(p>>3&1)*NUM_TILES],h=this.cgb._bgp[p&7],q=p&128,k=k[p&64?7-f:f],p&=32):k=n[o+k][f];for(;i<8&&e<160;i++,e++,l+=4){var j=k[p?7-i:i],r=h[j];b[e]=q?4:j;c[l]=r[0];c[l+1]=r[1];c[l+2]=r[2];c[l+3]=r[3]}i=0}while(e<160)},
render_window:function(b){if(!(this.wy>=144||this.wx>=160)){var c=this.image.data,a=this.vrambanks,d=this._pal.bg,h=this.mem.cgb,g=this._tiles.data,n=this.winmap?7168:6144;n+=(this.ly+this.wy>>3)*32;var m=this.ly%8,f=this.wx%8,i=(this.ly+this.wy)*640,l=this.wx,e=this.tiledata==0?128:0;do{var o=l>>3,j=a[0][n+o];this.tiledata==0&&(j=j+128&255);var k=!1,q=!1;h?(q=a[1][n+o],j=g[e+j+(q>>3&1)*NUM_TILES],d=this.cgb._bgp[q&7],k=q&128,j=j[q&64?7-m:m],q&=32):j=g[e+j][m];for(;f<8&&l<160;f++,l++,i+=4){var o=
j[q?7-f:f],p=d[o];b[l]=k?4:j[o];c[i]=p[0];c[i+1]=p[1];c[i+2]=p[2];c[i+3]=p[3]}f=0}while(l<160)}},render_sprites:function(b){for(var c=this.image.data,a=this.oam,d=this.mem.cgb,h=this._tiles.data,g=this.ly,n=this.objsize?16:8,m=0;m<40;m++){var f=m*4,i=a[f]-16,l=a[f+1]-8,e=a[f+2],f=a[f+3];if(!(i>g||i+n<=g||l<=-8||l>=160)){n==16&&(e&=254,g-i>=8&&(e+=1,i+=8));var o=(160*g+l)*4,j;d?(e=h[(f>>3&1*NUM_TILES)+e],j=this.cgb._obp[f&3]):(j=f&16?this._pal.obp1:this._pal.obp0,e=h[e]);i=f&64?e[7-(g-i)]:e[g-i];for(e=
0;e<8;e++,o+=4)if(!(l+e<0||l+e>=160||b[e+l]>3)){var k=i[f&32?7-e:e];k!=0&&!(f&128&&b[l+e]!=0)&&(k=j[k],c[o]=k[0],c[o+1]=k[1],c[o+2]=k[2],c[o+3]=k[3])}}}},rb:function(b){switch(b&255){case 64:return this.lcdon<<7|this.winmap<<6|this.winon<<5|this.tiledata<<4|this.bgmap<<3|this.objsize<<2|this.objon<<1|this.bgon;case 65:return this.lycly<<6|this.mode2int<<5|this.mode1int<<4|this.mode0int<<3|(this.lycly==this.ly?4:0)|this.mode;case 66:return this.scy;case 67:return this.scx;case 68:return this.ly;case 69:return this.lyc;
case 71:return this.bgp;case 72:return this.obp0;case 73:return this.obp1;case 74:return this.wy;case 75:return this.wx;case 79:return this.vrambank;case 81:return this.hdma_src>>8;case 82:return this.hdma_src&255;case 83:return this.hdma_dst>>8;case 84:return this.hdma_dst&255;case 85:return this.hdma5;case 104:return this.cgb.bgpi;case 105:return this.cgb.bgp[this.cgb.bgpi&63];case 106:return this.cgb.obpi;case 107:return this.cgb.obp[this.cgb.obpi&63]}return 255},wb:function(b,c){switch(b&255){case 64:this.lcdon=
c>>7&1;this.winmap=c>>6&1;this.winon=c>>5&1;this.tiledata=c>>4&1;this.bgmap=c>>3&1;this.objsize=c>>2&1;this.objon=c>>1&1;this.bgon=c&1;break;case 65:this.lycly=c>>6&1;this.mode2int=c>>5&1;this.mode1int=c>>4&1;this.mode0int=c>>3&1;break;case 66:this.scy=c;break;case 67:this.scx=c;break;case 69:this.lyc=c;break;case 70:this.oam_dma_transfer(c);break;case 71:this.bgp=c;this.update_palette(this._pal.bg,c);break;case 72:this.obp0=c;this.update_palette(this._pal.obp0,c);break;case 73:this.obp1=c;this.update_palette(this._pal.obp1,
c);break;case 74:this.wy=c;break;case 75:this.wx=c-7;break;case 79:if(this.mem.cgb)this.vrambank=c&1,this.vram=this.vrambanks[this.vrambank];break;case 81:this.hdma_src=this.hdma_src&255|c<<8;break;case 82:this.hdma_src=this.hdma_src&65280|c;break;case 83:this.hdma_dst=this.hdma_dst&255|c<<8;break;case 84:this.hdma_dst=this.hdma_dst&65280|c;break;case 85:this.hdma_dma_transfer(c);break;case 104:this.cgb.bgpi=c&191;break;case 106:this.cgb.obpi=c&191;break;case 105:this.cgb.bgp[this.cgb.bgpi&63]=c;
this.update_cgb_palette(this.cgb._bgp,this.cgb.bgp,this.cgb.bgpi);if(this.cgb.bgpi&128)this.cgb.bgpi=this.cgb.bgpi+1&191;break;case 107:if(this.cgb.obp[this.cgb.obpi&63]=c,this.update_cgb_palette(this.cgb._obp,this.cgb.obp,this.cgb.obpi),this.cgb.obpi&128)this.cgb.obpi=this.cgb.obpi+1&191}},update_tile:function(b){b=(b&8191)>>4;b+=this.vrambank*NUM_TILES;this._tiles.need_update=!0;this._tiles.to_update[b]=!0},update_palette:function(b,c){b[0]=JBA.GPU.Palette[c>>0&3];b[1]=JBA.GPU.Palette[c>>2&3];b[2]=
JBA.GPU.Palette[c>>4&3];b[3]=JBA.GPU.Palette[c>>6&3]},update_cgb_palette:function(b,c,a){var d=c[a&62],c=c[(a&62)+1],b=b[(a&63)>>3][(a&7)>>1];b[0]=d&31;b[1]=d>>5|(c&3)<<3;b[2]=c>>2&31;b[3]=255;for(d=0;d<3;d++)b[d]=b[d]*255>>5},oam_dma_transfer:function(b){b=(b&255)<<8;if(!(b>61696))for(var c=0;c<160;c++)this.oam[c]=this.mem.rb(b|c)},hdma_dma_transfer:function(){var b=this.hdma_src&65520,c=this.hdma_dst&8176;if(!(b>32752&&b<40960||b>57328||c<32768||c>40944))throw"Implement HDMA DMA transfer!";}};var Z80={Registers:function(){this.reset()},A:0,B:1,C:2,D:3,E:4,F:5,H:6,L:7,M:8,SP:0,PC:1};
...
JBA.Memory.prototype={gpu:null,rtc:null,input:null,timer:null,mbc:JBA.Memory.MBC.UNKNOWN,battery:0,cgb:0,rom:[],ram:[],wram:[],hiram:[],rombank:1,rambank:0,wrambank:1,ramon:0,mode:0,_ie:0,_if:0,reset:function(){this.rtc.reset();this.input.reset();this.rom=[];this.ram=new Uint8Array(RAM_SIZE);this.wram=new Uint8Array(WRAM_SIZE);this.hiram=new Uint8Array(HIRAM_SIZE);this.rombank=1;this.rambank=0;this.wrambank=1;this.mode=this.ramon=0;var b;for(b=0;b<RAM_SIZE;b++)this.ram[b]=0;for(b=0;b<WRAM_SIZE;b++)this.wram[b]=
0;for(b=0;b<HIRAM_SIZE;b++)this.hiram[b]=0},ram_size:function(){switch(this.rom[329]){case 0:return 0;case 1:return 2048;case 2:return 8192;case 3:return 32768;default:throw"Unknown ram size";}},serialize:function(b){var c;for(c=256;c<=335;c++)b.wb(this.rom[c]);for(c=0;c<RAM_SIZE;c++)b.wb(this.ram[c]);for(c=0;c<WRAM_SIZE;c++)b.wb(this.wram[c]);for(c=0;c<HIRAM_SIZE;c++)b.wb(this.hiram[c]);b.wb(this.rombank);b.wb(this.rambank);b.wb(this.wrambank);b.wb(this.ramon);b.wb(this.mode);b.wb(this.mbc);b.wb(this._if);
b.wb(this._ie);b.wb(this.cgb);b.wb(this.battery);this.input.serialize(b)},deserialize:function(b){var c;for(c=256;c<=335;c++)if(b.rb()!=this.rom[c])throw"Wrong cartridge is loaded for save state!";for(c=0;c<RAM_SIZE;c++)this.ram[c]=b.rb();for(c=0;c<WRAM_SIZE;c++)this.wram[c]=b.rb();for(c=0;c<HIRAM_SIZE;c++)this.hiram[c]=b.rb();this.rombank=b.rb();this.rambank=b.rb();this.wrambank=b.rb();this.ramon=b.rb();this.mode=b.rb();this.mbc=b.rb();this._if=b.rb();this._ie=b.rb();this.cgb=b.rb();this.battery=
b.rb();this.input.deserialize(b)},powerOn:function(){this.wb(65285,0);this.wb(65286,0);this.wb(65287,0);this.wb(65296,128);this.wb(65297,191);this.wb(65298,243);this.wb(65300,191);this.wb(65302,63);this.wb(65303,0);this.wb(65305,191);this.wb(65306,127);this.wb(65307,255);this.wb(65308,159);this.wb(65310,191);this.wb(65312,255);this.wb(65313,0);this.wb(65314,0);this.wb(65315,191);this.wb(65316,119);this.wb(65317,243);this.wb(65318,241);this.wb(65344,145);this.wb(65346,0);this.wb(65347,0);this.wb(65349,
0);this.wb(65351,252);this.wb(65352,255);this.wb(65353,255);this.wb(65354,0);this.wb(65355,0);this.wb(65535,0)},load_cartridge:function(b){if(typeof b=="string")for(var c=0;c<b.length;c++)this.rom[c]=b.charCodeAt(c)&255;else for(c in b)this.rom[c]=b[c];this.battery=1;switch(this.rom[327]){case 0:case 8:this.battery=0;case 9:this.mbc=JBA.Memory.MBC.NONE;break;case 1:case 2:this.battery=0;case 3:this.mbc=JBA.Memory.MBC.MBC1;break;case 5:this.battery=0;case 6:this.mbc=JBA.Memory.MBC.MBC2;break;case 17:case 18:this.battery=
0;case 15:case 16:case 19:this.mbc=JBA.Memory.MBC.MBC3;break;default:throw"Unknown/unimplemented MBC type: "+this.rom[327];}this.cgb=this.rom[323]&128},rw:function(b){return this.rb(b)|this.rb(b+1)<<8},ww:function(b,c){this.wb(b,c&255);this.wb(b+1,c>>8)},rb:function(b){switch(b>>12){case 0:case 1:case 2:case 3:return this.rom[b];case 4:case 5:case 6:case 7:return this.rom[this.rombank<<14|b&16383];case 8:case 9:return this.gpu.vram[b&8191];case 10:case 11:if(this.ramon)return this.rtc.current&8?this.rtc.regs[this.rtc.current&
7]:this.ram[this.rambank<<13|b&8191];else break;case 14:case 12:return this.wram[b&4095];case 13:return this.wram[this.wrambank<<12|b&4095];case 15:if(b<65024)return this.rb(b&57343);else if(b<65184)return this.gpu.oam[b&255];else if(!(b<65280))return b<65408?this.ioreg_rb(b):b<65535?this.hiram[b&127]:this._ie}return 255},ioreg_rb:function(b){switch(b>>4&15){case 0:switch(b&15){case 0:return this.input.rb(b);case 4:return this.timer.div;case 5:return this.timer.tima;case 6:return this.timer.tma;case 7:return this.timer.tac;
case 15:return this._if;default:return 255}case 1:case 2:case 3:return 255;case 4:if(this.cgb&&b==65357)throw"Can't go in double speed mode just yet for CGB!";case 5:case 6:return this.gpu.rb(b);case 7:if(this.cgb&&b==65392)return this.wrambank;default:throw"Not implemented reading that address!";}},wb:function(b,c){switch(b>>12){case 0:case 1:switch(this.mbc){case JBA.Memory.MBC.MBC1:case JBA.Memory.MBC.MBC3:this.ramon=(c&15)==10?1:0;break;case JBA.Memory.MBC.MBC2:b&256||(this.ramon^=1)}break;case 2:case 3:switch(this.mbc){case JBA.Memory.MBC.MBC1:this.rombank=
this.rombank&96|c&31;if(this.rombank==0)this.rombank=1;break;case JBA.Memory.MBC.MBC2:if(b&256)this.rombank=c&15;break;case JBA.Memory.MBC.MBC3:c&=127,this.rombank=c+!c}break;case 4:case 5:switch(this.mbc){case JBA.Memory.MBC.MBC1:if(this.mode==0)this.rombank=this.rombank&31|(c&3)<<5;else if(this.rambank=c&3,this.rambank>=8)throw"Need to add some more ram!";break;case JBA.Memory.MBC.MBC3:this.rtc.current=c&15,this.rambank=c&3}break;case 6:case 7:switch(this.mbc){case JBA.Memory.MBC.MBC1:this.mode=
c&1;break;case JBA.Memory.MBC.MBC3:this.rtc.latch(c)}break;case 8:case 9:this.gpu.vram[b&8191]=c;b<38912&&this.gpu.update_tile(b);break;case 10:case 11:this.ramon&&(this.rtc.current&8?this.rtc.wb(c):(this.mbc==JBA.Memory.MBC.MBC2&&(c&=15),this.ram[this.rambank<<13|b&8191]=c));break;case 12:case 14:this.wram[b&4095]=c;break;case 13:this.wram[this.wrambank<<12|b&4095]=c;break;case 15:if(b<65024)this.wb(b&57343,c);else if(b<65184)this.gpu.oam[b&255]=c;else if(!(b<65280))b<65408?this.ioreg_wb(b,c):b<
65535?this.hiram[b&127]=c:this._ie=c}},ioreg_wb:function(b,c){switch(b>>4&15){case 0:switch(b&15){case 0:this.input.wb(b,c);break;case 4:this.timer.div=0;break;case 5:this.timer.tima=c;break;case 6:this.timer.tma=c;break;case 7:this.timer.tac=c;this.timer.update();break;case 15:this._if=c}break;case 1:case 2:case 3:break;case 4:if(this.cgb&&b==65357)throw"Can't go in double speed mode just yet for CGB!";case 5:case 6:this.gpu.wb(b,c);break;case 7:if(this.cgb&&b==65392&&(c&=7,this.wrambank=c+!c,this.wrambank>=
8))throw"Need to add some more wram!";break;default:throw"Not implemented writing that address!";}}};JBA.CPU=function(){this.registers=new Z80.Registers;this.reset()};JBA.CPU.Interrupts=[];(function(){function b(a,b){return function(c,g,n,m){c.ime=0;c.halt=0;g._if&=~a&255;b(c,g,n,m)}}for(var c=0;c<32;c++)JBA.CPU.Interrupts[c]=c&1?b(1,Z80.ops.rst_40):c&2?b(2,Z80.ops.rst_48):c&4?b(4,Z80.ops.rst_50):c&8?b(8,Z80.ops.rst_58):c&16?b(16,Z80.ops.rst_60):function(){}})();
JBA.CPU.prototype={memory:null,ticks:0,reset:function(){this.ticks=0;this.registers.reset()},serialize:function(b){this.registers.serialize(b)},deserialize:function(b){this.registers.deserialize(b)},exec:function(){var b=this.registers,c=this.memory,a=b.u8regs,d=b.u16regs;if(b.halt==0){var h=c.rb(d[Z80.PC]++);Z80.map[h](b,c,a,d)}else a[Z80.M]=1;h=a[Z80.M]*4;a[Z80.M]=0;if(b.ime){var g=c._if&c._ie;g&&(JBA.CPU.Interrupts[g](b,c,a,d),h+=a[Z80.M]*4)}this.ticks+=h;c.timer&&c.timer.step(h/4);return h}};JBA.Input=function(b){this.memory=b;this.reset()};JBA.Input.SEL={BUTTON:32,DIRECTION:16};JBA.Input.Map={buttons:{90:14,88:13,13:7,188:11},directions:{37:13,38:11,39:14,40:7}};
JBA.Input.prototype={col:JBA.Input.SEL.DIRECTION,memory:null,buttons:15,directions:15,reset:function(){this.col=JBA.Input.SEL.DIRECTION;this.directions=this.buttons=15},serialize:function(b){b.wb(this.col);b.wb(this.buttons);b.wb(this.directions)},deserialize:function(b){this.col=b.rb();this.buttons=b.rb();this.directions=b.rb()},rb:function(){switch(this.col){case JBA.Input.SEL.BUTTON:return this.buttons;case JBA.Input.SEL.DIRECTION:return this.directions;default:return 15}},wb:function(b,c){this.col=
~c&48},keydown:function(b){var c=!0,a=JBA.Input.Map.directions[b];a&&(this.directions&=a,this.memory._if|=16,c=!1);if(a=JBA.Input.Map.buttons[b])this.buttons&=a,this.memory._if|=16,c=!1;return c},keyup:function(b){var c=!0,a=JBA.Input.Map.directions[b];a&&(this.directions|=~a&15,c=!1);if(a=JBA.Input.Map.buttons[b])this.buttons|=~a&15,c=!1;return c}};JBA.Timer=function(){this.reset()};
